...
- 本导航收录的第三方 Skill 均来源于 WorkBuddy 公开市场，并通过上述公开市场归档
  按需拉取。
- 本项目的整理、目录和安装能力仅供个人研究与学习，不支持商用，也不对任何第三方
  Skill 提供商用授权。
- 如果某个 Skill 附带独立 `LICENSE`、`NOTICE` 或其他授权文件，以其具体条款为准；
  未声明许可证时，不得推定可以复制、修改、再次分发或商用。
- 版权、商标及其他相关权益归原作者或相关权利人所有。WorkBuddy 名称仅用于说明
  内容来源。

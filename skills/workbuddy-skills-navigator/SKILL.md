...
> 来源与使用限制：目录中的第三方 Skill 均来源于 WorkBuddy 公开市场，并通过
> 公开市场归档按需拉取。仅供个人研究与学习，不支持商用；本导航不提供第三方
> 内容的商用授权。版权与具体许可归各原作者或相关权利人所有。

这是第三方学习归档的导航，不代表 WorkBuddy 或腾讯官方发行。各 Skill 的许可证、
账号和服务依赖互不相同。用户询问来源或许可时，读取
